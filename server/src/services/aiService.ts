...
**الخطوط الملونة موجودة على الصورة:**
- ستجد خطوط أفقية ملونة مرسومة على الشارت
- **خط أحمر سميك** = BSL (قمة رئيسية)
- **خط أخضر سميك** = SSL (قاع رئيسي)  
- **خطوط زرقاء** = Swing High/Low

**كيف تتعرف على Sweep:**
1. انظر للشموع التي **لامست أو اخترقت** الخطوط الملونة
2. ابحث عن **ذيول طويلة** (wicks) عند هذه الخطوط
3. إذا السعر **عاد داخل النطاق** بعد الاختراق = Sweep ✅
4. **لا تقل "لا يوجد sweep" بسهولة** - ابحث جيداً!

**قاعدة مهمة:**
- إذا رأيت شموع تلامس الخط الأخضر (SSL) مع ذيول = احتمال SSL Sweep
- إذا رأيت شموع تلامس الخط الأحمر (BSL) مع ذيول = احتمال BSL Sweep
