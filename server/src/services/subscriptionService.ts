...
export const initializeDefaultPackages = async (): Promise<void> => {
  ...
  try {
    ...
    createVipPackage(
      ...
      'Basic weekly subscription with unlimited signals',
      'باقة أسبوعية أساسية مع إشارات غير محدودة',
      'weekly',
      7,
      50,   // 50 عملة
      200,  // 200 عملة مجانية
      -1,   // إشارات غير محدودة
      ['تحليل ICT متقدم', 'دعم فني أولوية', 'إشارات غير محدودة', 'إشعارات فورية']
    );
    ...
    createVipPackage(
      ...
      'Premium monthly subscription with unlimited signals',
      'باقة شهرية مميزة مع إشارات غير محدودة',
      'monthly',
      30,
      150,  // 150 عملة
      1000, // 1000 عملة مجانية
      -1,   // إشارات غير محدودة
      ['تحليل ICT متقدم', 'دعم فني VIP', 'إشارات غير محدودة', 'إشعارات فورية', 'تحليل متعدد الأزواج', 'تقارير أسبوعية']
    );
    ...
    createVipPackage(
      ...
      'Ultimate yearly subscription with unlimited signals',
      'باقة سنوية مطلقة مع إشارات غير محدودة',
      'yearly',
      365,
      1000, // 1000 عملة
      5000, // 5000 عملة مجانية
      -1,   // إشارات غير محدودة
      ['تحليل ICT متقدم', 'دعم فني VIP', 'إشارات غير محدودة', 'إشعارات فورية', 'تحليل متعدد الأزواج', 'تقارير أسبوعية', 'استشارات شخصية', 'وصول مبكر للميزات الجديدة']
    );

    // باقة العملات فقط - تم إزالتها
    // المستخدمون يشترون الباقات بالعملات مباشرة
